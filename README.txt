...
#Execute the following code in the PowerShell for bilstm
python .\bilstm_sentiment.py `
  --csv "路径\imdb_clean.csv" `
  --w2v "路径\features\w2v.kv" `
  --epochs 8 --batch_size 64 --embed_dim 100 --hidden_dim 128 --device auto